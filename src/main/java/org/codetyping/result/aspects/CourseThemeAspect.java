package org.codetyping.result.aspects;
...
public class CourseThemeAspect {
    ...
    @Pointcut(value = "execution(* org.codetyping.result.services.ResultService.createResultByUserID(..)) " +
    ...
    @Pointcut(value = "execution(* org.codetyping.result.services.ResultService.createSessionResultBySession(..)) " +
